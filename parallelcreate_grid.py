...
TOPIC_NAME = 'scorianigrid'
SUBSCRIPTION_NAME = 'scorianisub'
...
async def run_example():
    ...
    event_client.event_subscriptions.create_or_update(scope, SUBSCRIPTION_NAME,
        {
            'destination': {
                'endpoint_type': "EventHub",
                'resource_id': "/subscriptions/e243327e-b18c-4766-8f44-d9a945082e57/resourceGroups/scorianihub/providers/Microsoft.EventHub/namespaces/scorianitestgrid/eventhubs/scorianigridhub"
            }
        }
    )
